...
@section('content')
    <div class="space-y-8 animate-fadeInUp">
        ...
        <div class="relative rounded-2xl shadow-2xl overflow-hidden"
            style="background: linear-gradient(to bottom right, #22A4B8, #1b7f8f);">
            ...
            <div class="relative p-8 text-white">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="w-24 h-24 bg-black/20 rounded-full flex items-center justify-center backdrop-blur-sm">
