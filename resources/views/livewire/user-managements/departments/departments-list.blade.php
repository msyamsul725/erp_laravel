                ...
                <div class="btn-icon">
                    ...
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 21h18M9 8h6M9 12h6M9 16h6M4 21V5a1 1 0 011-1h14a1 1 0 011 1v16" />
                    </svg>
                </div>
                <div>
                    <h2 class="text-2xl font-bold ext-grat-900">Departments Management</h2>
                    <p class="text-sm text-gray-600 mt-1">Manage departments and organizational structure</p>
                </div>
            </div>


            @permission('users.create')
                <button wire:click="$dispatch('openUserForm')" class="btn-primary">
        ...
        <div
            ...
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input wire:model.live="search" type="text" placeholder="Search department by name, code..."
                    ...
                    <tr
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    ...
                                    <span
                                        class="text-sm font-bold text-white">{{ substr($department->name, 0, 2) }}</span>
                                </div>
                                <div>
                                    <div class="text-sm font-semibold text-gray-900">{{ $department->name }}</div>
                                    <div class="text-xs text-gray-500">System department</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-5 whitespace-nowrap">
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <div>
                                    <div class="font-medium">{{ $department->created_at->format('M d, Y') }}</div>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                @permission('users.edit')
                                    <button wire:click="$dispatch('openUserForm', { departmentId: {{ $department->id }} })"
                            ...
                            <div class="flex flex-col items-center justify-center">
                                <div
                                    ...
                                    <svg class="w-10 h-10 text-gray-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <!-- Icon building/office untuk departemen -->
                                ...
                                <p class="text-gray-500 mb-6 max-w-sm text-center">
                                    ...
                                    @else
                                        Get started by creating your first department to organize your system.
                                    @endif
                                </p>
                                ...
                                @if (!$search)
                                    @permission('users.create')
                                        <button wire:click="$dispatch('openDepartmentForm')"
                                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white font-semibold rounded-xl hover:from-green-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
    ...
    <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t border-gray-200 rounded-b-2xl">
        <div class="flex items-center justify-between">
            <div class="text-sm text-gray-600">
                Showing <span class="font-medium">{{ $departments->firstItem() ?? 0 }}</span> to <span
                    class="font-medium">{{ $departments->lastItem() ?? 0 }}</span> of <span
                    class="font-medium">{{ $departments->total() }}</span> departments
            </div>
