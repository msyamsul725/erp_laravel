<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="w-16 h-16 btn-icon rounded-2xl flex items-center justify-center shadow-lg">
    ...
    <form wire:submit.prevent="updateProfile" class="space-y-6">
        ...
        <div class="flex items-center justify-end pt-6 border-t border-gray-200">
            <div class="flex space-x-3">
                ...
                <button type="submit"
                    class="inline-flex items-center px-6 py-2 btn-primary text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700"
