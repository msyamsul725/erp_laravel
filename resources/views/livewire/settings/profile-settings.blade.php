    ...
    <form wire:submit.prevent="updateProfile" class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
            <div class="flex items-center space-x-6">
                <div class="w-20 h-20 btn-icon rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4">
                        <label for="avatar"
                            class="cursor-pointer inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                        ...
                        @if ($avatar)
                            <span
                                class="text-sm text-green-600 font-medium">{{ $avatar->getClientOriginalName() }}</span>
                        @endif
                    </div>
                    @error('avatar')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    ...
                    <div class="text-xs text-green-600 font-medium">
                        {{ auth()->user()->is_active ? 'Active' : 'Inactive' }}</div>
                </div>
            </div>
        </div>
